...
export function DoorPlaque() {
  return (
    <div className="material-brass relative rounded-[4px] px-[6%] py-[4%] shadow-[0_0.6vmax_1.6vmax_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,248,220,0.55),inset_0_-2px_4px_rgba(0,0,0,0.35)]">
      ...
      <p className="engraved-deep text-center text-[clamp(0.85rem,calc(var(--door-w)*0.03),1.15rem)] font-semibold uppercase tracking-[0.22em] sm:tracking-[0.34em]">
        {teacher.room}
      </p>

      <p className="engraved-deep mt-[calc(var(--door-w)*0.016)] whitespace-nowrap text-center font-display text-[clamp(1.85rem,calc(var(--door-w)*0.078),3rem)] leading-none tracking-wide">
        {teacher.name}
      </p>
      ...
      <p className="engraved-deep text-center text-[clamp(0.85rem,calc(var(--door-w)*0.029),1.15rem)] font-medium leading-relaxed tracking-[0.06em] sm:tracking-[0.1em]">
        {ROLE_LINES.map((line) => (
